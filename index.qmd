...
data set. We are also outputting the variable importance using gini
...
the questionnaire and still have high accuracy. Here we have selected the
top 4 most important questions and re-run the classification to gauge
accuracy. 
