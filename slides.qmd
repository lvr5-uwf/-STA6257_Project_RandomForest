...
-   Next we will discuss applications of Random Forest.
...
This decision tree shows a split on the HighBP field, with 44% having Yes on the left, and 56% having No on the right, and so on.  The lowest level shows the classification.
