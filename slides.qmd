...
- The method is attributed to Dr. Leo Brieman of the University of California at Berkeley.
...
- We accomplish this by calculating the variable importance using the Gini impurity value.
...
```
With this code we load the data into a dataframe and set the field types to their correct type and factor levels.
...
```
With this code we create the summary of the data using the GT Summary package, and then use that data to create charts to display the data visualizations shown on the next slide.
