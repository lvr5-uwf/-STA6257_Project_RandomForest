...
-   There is a need to predict an individual's risk of developing
    diabetes in the hopes that preventive measures can be taken to
    improve outcomes [@DiabetesDataset].
-   This dataset is a subset of data from the The Behavioral Risk Factor
...
-   This result shows a questionnaire with 4 questions still has 74.0%
...
-   True Positive (TP) is a sample classified as positive which is in
    fact positive, True Negative (TN) a negative which indeed is
    negative, False Positive (FP) a positive when it is in fact
